...
public class UserServiceImpl implements UserService {
    ...
    public void addFrend(String uid, String ids, int gztype, DefaultResponseListener<BaseResponse> listener) {
        ...
        params.put("uid", uid);
        params.put("ids", ids);
        params.put("gztype", gztype+"");
        GsonRequest request = new GsonRequest(Request.Method.POST, RequestURL.API_ADD_FREND, params, null,
                new TypeToken<BaseResponse<String>>() {
                },
                listener, listener);
        AppManager.getRequestQueue().add(request);
    ...
    @Override
    public void checkFrend(String uid, int userId, DefaultResponseListener<BaseResponse<String>> listener) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("uid", uid);
        params.put("userId", userId+"");
        GsonRequest request = new GsonRequest(Request.Method.POST, RequestURL.API_CHECK_ISFREND, params, null,
                new TypeToken<BaseResponse<String>>() {
                },
                listener, listener);
        AppManager.getRequestQueue().add(request);
    ...
    @Override
    public void updateJpushId(String uid, String jid, DefaultResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("uid", uid);
        params.put("jid", jid);
        GsonRequest request = new GsonRequest(Request.Method.POST, RequestURL.API_UPDATE_JPUSHID, params, null,
