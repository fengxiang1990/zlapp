 ...
 */
public class UpdateQianMingActivity extends BaseActivityWithToolBar {
    ...
    protected void onTextRight1Click() {
        ...
        new UserServiceImpl().updateUserInfo(AppConfig.getUid(preference), null,
                null,
                null, null, String.valueOf(editText.getText()), null, null, null, null, null, null
                ,null,new DefaultResponseListener<BaseResponse>() {
                    ...
                    public void onSuccess(BaseResponse response) {
                        if(response!=null && response.getStatus().equals(AppConfig.HTTP_OK)){
                            ...
                            user.setIntroduce(String.valueOf(editText.getText()));
                            AppConfig.saveUpdateInfo(preference,user);
                            ToastUtil.show(UpdateQianMingActivity.this,response.getMessage());
                            finish();
                        }
                    }
                    ...
                    public void onError(VolleyError error) {
                        ToastUtil.show(UpdateQianMingActivity.this,error.getMessage());
                    }
                }
        );
    }
