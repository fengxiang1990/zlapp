package com.zl.app.view.datetimepicker;
...
public class DateTimePickDialogUtil implements OnDateChangedListener, OnTimeChangedListener {
    ...
    public Calendar getCalendarByInintData(String initDateTime) {
        ...
        Date date = DateUtil.StringToDate(initDateTime);

        int currentYear = DateUtil.getYear(date);
        int currentMonth = DateUtil.getMonth(date) - 1;
        int currentDay = DateUtil.getDay(date);
        int currentHour = DateUtil.getHour(date);
        int currentMinute = DateUtil.getMinute(date);
    ...
    private void resizeNumberPicker(NumberPicker np) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                DeviceConfig.getScreenWidth() / 8, LinearLayout.LayoutParams.WRAP_CONTENT);
